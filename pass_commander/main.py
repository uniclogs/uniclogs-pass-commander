...
tle_cache = {
    'OreSat0': ['ORESAT0', '1 52017U 22026K   23092.57919752  .00024279  00000+0  10547-2 0  9990',
                '2 52017  97.5109  94.8899 0023022 355.7525   4.3512 15.22051679 58035'],
    '2022-026K': ['ORESAT0', '1 52017U 22026K   23092.57919752  .00024279  00000+0  10547-2 0  9990',
                  '2 52017  97.5109  94.8899 0023022 355.7525   4.3512 15.22051679 58035'],
    'end': True
}
...
class Main:
    def __init__(self,
                 ...
                 o_rotator=Rotator(host_rotator, az_cal=az_cal, el_cal=el_cal, local_only=local_only),
    ...
    def autorun(self, count=9999):
        ...
        while count > 0:
            ...
            np = self.track.sleep_until_next_pass(local_only, tle_cache)
    ...
    def work_pass(self, packet=edl_packet):
        ...
        self.track.calibrate(local_only, owmid)
    ...
    def update_rotator(self):
        ...
        if not local_only:
            self.rot.go(*tuple(deg(x) for x in azel), no_rot=no_rot)
